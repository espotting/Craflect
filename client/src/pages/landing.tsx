    ...
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <img src={isDark ? logoTransparent : logoLight} alt="Craflect" className={`${isDark ? "h-10" : "h-8"} w-auto`} />
      ...
      <nav className="relative z-10 w-full px-4 sm:px-6 py-5 flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          <img src={isDark ? logoTransparent : logoLight} alt="Craflect" className={`${isDark ? "h-12" : "h-10"} w-auto object-contain`} data-testid="logo-landing" />
        </div>
